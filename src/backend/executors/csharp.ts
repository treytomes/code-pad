...
export class CSharpExecutor {
  ...
  private getDumpExtensions(): string[] {
    return [
      ...
      '    }',
      '    ',
      '    // Overload for Task<T>: awaits the task and dumps the result.',
      '    // This allows: await MyAsyncMethod().Dump("Result");',
      '    public static async System.Threading.Tasks.Task<T> Dump<T>(this System.Threading.Tasks.Task<T> task, string label = null)',
      '    {',
      '        var result = await task;',
      '        DumpObject(result, label);',
      '        return result;',
      '    }',
      '    ',
      '    // Overload for Task (non-generic): awaits the task.',
      '    public static async System.Threading.Tasks.Task Dump(this System.Threading.Tasks.Task task, string label = null)',
      '    {',
      '        await task;',
